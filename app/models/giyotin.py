...
from sqlalchemy.dialects.postgresql import JSONB  # PostgreSQL için JSON saklama
...
class GiyotinRecord(Base):
    ...
    cost_details = Column(JSONB, nullable=True)       # Maliyet detayları ve kalemler
    cut_optimization = Column(JSONB, nullable=True)   # Kesim planı ve fire oranları
